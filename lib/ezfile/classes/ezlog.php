...
class eZLog
{
    ...
    */
    ...
    static function debug($message, $label='', $logName = 'common.log', $dir = 'var/log' )
    {
      $logMessage = $label."\n";
      $logMessage .= ( is_object( $message ) || is_array( $message ) ) ? eZDebug::dumpVariable( $message ) :  $message ;
      self::write( $logMessage, $logName, $dir );
    }
