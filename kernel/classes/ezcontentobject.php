...
class eZContentObject extends eZPersistentObject
{
    ...
    function copy( $allVersions = true )
    {
        ...
        //Hack Kaliop to trigger Signal in sf stack

        $params=array(
            'srcContentId'=> $this->attribute('id'),
            'srcVersionNo' => $this->attribute('current_version'),
            'dstContentId' => $contentObject->attribute( 'id' ),
            'dstVersionNo' => $contentObject->attribute('current_version'),
            'dstParentLocationId' => $contentObjectVersion->mainParentNodeID()
        );
        ezpEvent::getInstance()->notify( 'content/copy', array($params));
    ...
    function purge()
    {
        ...
        ezpEvent::getInstance()->notify( 'content/delete', array($params));
    }
