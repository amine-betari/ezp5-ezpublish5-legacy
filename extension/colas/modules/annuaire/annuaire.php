...
if(eZUser::isUserLoggedIn($usrObj->id())){
...
if($action == 'print'){
    ...
    $user = BouyguesAnnuaire::getCollaborator($http->getVariable( 'id' ));
...
print_r('action -->'.$action. ' - view -->'.$view);

$tpl->setVariable('annuaireMenu', MySOAP::getAnnuaireXml());

$Result['content'] = $tpl->fetch( "design:annuaire/".$view.".tpl" );
$Result['path'] = array(
    array(  'url'   => false,
