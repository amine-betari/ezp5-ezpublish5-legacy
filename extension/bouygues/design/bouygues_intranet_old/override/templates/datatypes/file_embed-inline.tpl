...
{if $object_parameters.label}{$object_parameters.label}{else}{$object.name|wash}{/if} (<span class="extension">{if is_set($pictoName)}{$pictoName}{else}{$object.data_map.file.content.original_filename|extract_right( 3 )}{/if}</span>)</a>
<br />
{undef}