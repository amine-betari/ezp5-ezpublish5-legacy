...
<div class="block">
    ...
    {/section}
    <input type="hidden" name="realAction" value="PublishButton" id="realAction" />
    ...
    <input class="button" type="submit" name="PublishButton" value="{'Send for publishing'|i18n( 'design/admin/content/edit' )} et télécharger au format HTML" onClick="$('#realAction').val('HtmlButton');" title="{'Publish the contents of the draft that is being edited. The draft will thus become the published version of the object.'|i18n( 'design/admin/content/edit' )}" />
