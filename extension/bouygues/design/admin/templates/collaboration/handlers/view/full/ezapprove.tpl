...
<h2 class="context-title">{"Preview"|i18n('design/admin/collaboration/handler/view/full/ezapprove')} - <a href="/content/versionview/{$content_version.contentobject_id}/{$content_version.version}/{$$content_version.initial_language.locale}/site_access/fre" target="_blank" style="color: #ffffff">Afficher en plein écran</a></h2>
