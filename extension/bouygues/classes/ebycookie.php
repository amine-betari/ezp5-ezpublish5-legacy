<?php
/**
 * API de gestion cookie
 * This class is not user anymore
 *
 * @author J. Leger
 * @version $Id: ebycookie.php
...
class Cookie
{
    ...
    public static function get($key)
    {
        ...
        if (is_array($key))
        {
//eZLog::write ( 'Check for array', 'bouygues_cookie.log', 'var/log'); 
        	// Grab key/value pair
            list ($k, $v) = each($key);
        ...
        }else if (isset($_COOKIE[$key])){// Return single key if it's set
        	 
//eZLog::write ( 'Return single key if it s set key :'.$key .'  cookie :'. print_r($_COOKIE,true), 'bouygues_cookie.log', 'var/log');        	
        	return $_COOKIE[$key];
           
        
    	}else{// Otherwise return null
    		 
//eZLog::write ( 'Otherwise return null', 'bouygues_cookie.log', 'var/log');     		
    		return null;
    	}
    }
